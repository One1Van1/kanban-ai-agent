...
> ⚠️ **ВНИМАНИЕ: Документация обновляется!**  
> Эта документация частично устарела после рефакторинга (ноябрь 2025).  
> **Актуальную информацию смотрите в:** [`FOLDER_GUIDE.md`](../FOLDER_GUIDE.md)  
> **Новая структура описана в:** [`REFACTORING_GUIDE.md`](../docs/REFACTORING_GUIDE.md)
