...
const store_task_history_controller_1 = require("../features/kanban-management/POST/store-task-history/store-task-history.controller");
const store_task_history_service_1 = require("../features/kanban-management/POST/store-task-history/store-task-history.service");
const get_agent_task_history_controller_1 = require("../features/kanban-management/GET/get-agent-task-history/get-agent-task-history.controller");
const get_agent_task_history_service_1 = require("../features/kanban-management/GET/get-agent-task-history/get-agent-task-history.service");
const get_task_history_controller_1 = require("../features/kanban-management/GET/get-task-history/get-task-history.controller");
const get_task_history_service_1 = require("../features/kanban-management/GET/get-task-history/get-task-history.service");
const get_task_statistics_service_1 = require("../features/kanban-management/GET/get-task-statistics/get-task-statistics.service");
const get_task_statistics_controller_1 = require("../features/kanban-management/GET/get-task-statistics/get-task-statistics.controller");
