...
exports.ApiChangeTaskStatus = ApiChangeTaskStatus;
const common_1 = require("@nestjs/common");
const swagger_1 = require("@nestjs/swagger");
const change_task_status_request_dto_1 = require("./change-task-status.request.dto");
const change_task_status_response_dto_1 = require("./change-task-status.response.dto");
function ApiChangeTaskStatus() {
    return (0, common_1.applyDecorators)((0, swagger_1.ApiOperation)({
      ...
      `,
        ...
        type: change_task_status_request_dto_1.ChangeTaskStatusRequestDto,
        description: 'Status change details including new status and optional context',
        examples: {
            start_work: {
            ...
            agent_status_change: {
                ...
                value: {
                    newStatus: 'in-review',
                    statusComment: 'Автоматически переведено в ревью после завершения разработки',
                    context: {
        ...
        type: change_task_status_response_dto_1.ChangeTaskStatusResponseDto,
        example: {
            success: true,
