...
export function ApiGetBoardStructure() {
  return applyDecorators(
    ...
    ApiQuery({
      ...
      description:
        'Include detailed column metadata (WIP limits, descriptions, etc.)',
      required: false,
      type: 'boolean',
      example: false,
    }),
    ...
    ApiQuery({
      ...
      description:
        'Include sample tasks for each column (useful for AI context)',
      required: false,
      type: 'boolean',
      example: false,
    }),
    ...
    ApiResponse({
      ...
      type: GetBoardStructureResponseDto,
      content: {
        'application/json': {
          examples: {
            minimal_structure: {
            ...
            agent_context: {
              ...
              value: {
                ...
                workflow: {
                  ...
                  description:
                    'Specialized workflow for AI/ML development tasks',
                  allowedTransitions: {
