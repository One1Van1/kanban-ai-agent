...
import { CheckProgressTasksController } from './check-progress-tasks.controller';
...
@Module({
  ...
  controllers: [CheckProgressTasksController],
  providers: [
  ...
  exports: [CheckProgressTasksService],
})
export class CheckProgressTasksModule {}
