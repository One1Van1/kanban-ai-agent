...
// import { RunAutoWorkflowModule } from '../run-auto-workflow/run-auto-workflow.module'; // НЕ СТРИЖКИ: закомментировано
...
@Module({
  imports: [
    // RunAutoWorkflowModule, // НЕ СТРИЖКИ: закомментировано
